...
sonarqube {
    properties {
        ...
        property(
            ...
            "src/main/kotlin/com/menta/api/seeds/ApiSeedsApplication.kt, " +
                    "src/main/kotlin/com/menta/api/seeds/shared/other/util/**, " +
                    "src/main/kotlin/com/menta/api/seeds/shared/config/**, "
        )
    }
}
