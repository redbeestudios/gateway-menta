package com.menta.api.seeds.shared.other.error
...
import com.menta.api.seeds.shared.other.error.model.ApplicationError.Companion.forbiddenException
import com.menta.api.seeds.shared.other.error.model.ApplicationError.Companion.messageNotReadable
import com.menta.api.seeds.shared.other.error.model.ApplicationError.Companion.missingParameter
import com.menta.api.seeds.shared.other.error.model.ApplicationError.Companion.unhandledException
import com.menta.api.seeds.shared.other.error.model.exception.ApplicationErrorException
import com.menta.api.seeds.shared.other.error.providers.ErrorResponseProvider
import com.menta.api.seeds.shared.other.util.getRootException
import com.menta.api.seeds.shared.other.util.log.CompanionLogger
import com.menta.api.seeds.shared.other.util.pairedWith
import com.menta.api.seeds.shared.other.util.rest.asResponseEntity
