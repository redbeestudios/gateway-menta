...
sonarqube {
    properties {
        ...
        property(
            ...
            "src/main/kotlin/com/menta/api/credibanco/ApiCredibancoAdapterApplication.kt, " +
                    "src/main/kotlin/com/menta/api/credibanco/shared/**, " +
                    "src/main/kotlin/com/menta/api/credibanco/config/**, "
        )
    }
}
