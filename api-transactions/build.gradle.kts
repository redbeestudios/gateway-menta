...
sonarqube {
	properties {
		...
		property(
			...
			"src/main/kotlin/com/menta/api/transactions/shared/kafka/**," +
					"src/main/kotlin/com/menta/api/transactions/shared/error/model/**," +
			"src/main/kotlin/com/menta/api/transactions/config/**"
		)
