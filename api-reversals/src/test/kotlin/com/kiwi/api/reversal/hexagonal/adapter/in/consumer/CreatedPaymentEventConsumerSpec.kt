...
class CreatedPaymentEventConsumerSpec : FeatureSpec({
    ...
    val consumer = CreatedPaymentEventConsumer(createOperation, consumerMessageResolver)

    feature("consume created payment event") {
