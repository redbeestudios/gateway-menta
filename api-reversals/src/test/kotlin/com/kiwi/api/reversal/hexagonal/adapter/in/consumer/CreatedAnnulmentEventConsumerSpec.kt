...
class CreatedAnnulmentEventConsumerSpec : FeatureSpec({
    ...
    val consumer = CreatedAnnulmentEventConsumer(createOperation, consumerMessageResolver)

    beforeEach { clearAllMocks() }

    feature("consume created annulment event") {
