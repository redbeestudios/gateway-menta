...
dependencies {
	...
	// Menta Security
	implementation("com.menta:libs-security:0.2.0-RELEASE")
...
sonarqube {
	properties {
		...
		property(
			...
			"src/main/kotlin/com/menta/apiacquirers/ApiAcquirersApplication.kt, " +
					"src/main/kotlin/com/menta/api/apiacquirers/shared/util/**, " +
					"src/main/kotlin/com/menta/api/apiacquirers/shared/config/**"
		)
	}
}
tasks.sonarqube {
