package com.menta.api.users.authorities.shared.other.error

import com.fasterxml.jackson.module.kotlin.MissingKotlinParameterException
import com.menta.api.users.authorities.shared.other.error.model.ApiErrorResponse
import com.menta.api.users.authorities.shared.other.error.model.ApplicationError
import com.menta.api.users.authorities.shared.other.error.model.ApplicationError.Companion.messageNotReadable
import com.menta.api.users.authorities.shared.other.error.model.ApplicationError.Companion.missingParameter
import com.menta.api.users.authorities.shared.other.error.model.ApplicationError.Companion.unhandledException
import com.menta.api.users.authorities.shared.other.error.model.ApplicationError.Companion.validationError
import com.menta.api.users.authorities.shared.other.error.model.exception.ApplicationErrorException
import com.menta.api.users.authorities.shared.other.error.providers.ErrorResponseProvider
import com.menta.api.users.authorities.shared.other.util.getRootException
import com.menta.api.users.authorities.shared.other.util.log.CompanionLogger
import com.menta.api.users.authorities.shared.other.util.pairedWith
import com.menta.api.users.authorities.shared.other.util.rest.asResponseEntity
...
class ErrorHandler(
    ...
    fun handleMethodArgumentNotValidException(ex: MethodArgumentNotValidException): ResponseEntity<ApiErrorResponse> =
        ex.bindingResult.allErrors.first().let {
            validationError(ex, it.defaultMessage).asResponse()
        }
