...
sonarqube {
    properties {
        ...
        property(
            ...
            "src/main/kotlin/com/menta/api/users/authorities/ApiUsersAuthoritiesApplication.kt, " +
                    "src/main/kotlin/com/menta/api/users/authorities/shared/other/util/**, " +
                    "src/main/kotlin/com/menta/api/users/authorities/shared/config/**, "
        )
    }
}
