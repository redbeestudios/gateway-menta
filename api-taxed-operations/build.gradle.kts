...
sonarqube {
	properties {
		...
		property("sonar.coverage.exclusions", "src/main/kotlin/com/menta/api/taxed/operations/shared/kafka/**")
		property("sonar.coverage.exclusions", "src/main/kotlin/com/menta/api/taxed/operations/shared/error/**")
		property("sonar.coverage.exclusions", "src/main/kotlin/com/menta/api/taxed/operations/shared/util/**")
		property("sonar.coverage.exclusions", "src/main/kotlin/com/menta/api/taxed/operations/shared/config/**")
		property("sonar.coverage.exclusions", "src/main/kotlin/com/menta/api/taxed/operations/adapter/out/db/entity/**")
