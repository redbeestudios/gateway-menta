...
sonarqube {
	properties {
		...
		property(
			...
			"src/main/kotlin/com/menta/api/customers/ApiCustomersApplication.kt, " +
					"src/main/kotlin/com/menta/api/customers/shared/openApi/OpenApiConfiguration.kt, " +
					"src/main/kotlin/com/menta/api/customers/shared/util/**, " +
					"src/main/kotlin/com/menta/api/customers/shared/config/**, "
		)
	}
}
