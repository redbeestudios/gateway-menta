...
dependencies {
    ...
    // Menta Security
    implementation("com.menta:libs-security:0.3.3-RELEASE")
...
sonarqube {
    properties {
        ...
        property(
            ...
            "src/main/kotlin/com/menta/api/users/ApiUsersApplication.kt, " +
            "src/main/kotlin/com/menta/api/users/shared/other/util/**, " +
            "src/main/kotlin/com/menta/api/users/shared/other/config/**" +
            "src/main/kotlin/com/menta/api/users/shared/kafka/**"
        )
    }
}
