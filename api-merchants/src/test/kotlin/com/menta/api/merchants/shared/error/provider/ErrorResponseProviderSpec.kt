package com.menta.api.merchants.shared.error.provider
...
class ErrorResponseProviderSpec : FeatureSpec({
    ...
    feature("provide error response") {
        ...
        scenario("error response provided") {
            ...
            val error = acquirerMerchantNotFound("an acquirer", UUID.fromString("0f14d0ab-9605-4a62-a9e4-5ed26688389b"))
